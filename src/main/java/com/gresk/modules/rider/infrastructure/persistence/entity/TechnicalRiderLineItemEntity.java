...
@Entity
@Table(name = "technical_rider_line_items")
@Getter
@Setter
@Builder
@NoArgsConstructor(access = AccessLevel.PROTECTED)
@AllArgsConstructor(access = AccessLevel.PRIVATE)
public class TechnicalRiderLineItemEntity {
    ...
    private TechnicalRiderEntity rider;
    ...
    private com.gresk.modules.rider.domain.model.valueobject.FulfillmentSource fulfillmentSource;
