...
public class SetTechnicalLineItemFulfillmentUseCase {

    private final RiderRepositoryPort riderRepository;

    @Transactional
    public TechnicalRider execute(String riderId, String promoterId, String lineItemId, String fulfillmentSource) {
