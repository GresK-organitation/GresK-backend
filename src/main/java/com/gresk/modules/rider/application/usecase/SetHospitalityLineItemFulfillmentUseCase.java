...
public class SetHospitalityLineItemFulfillmentUseCase {

    private final HospitalityRiderRepositoryPort riderRepository;

    @Transactional
    public HospitalityRider execute(String riderId, String promoterId, String lineItemId, String fulfillmentSource) {
        ...
        rider.setLineItemFulfillment(UUID.fromString(lineItemId), FulfillmentSource.valueOf(fulfillmentSource));
