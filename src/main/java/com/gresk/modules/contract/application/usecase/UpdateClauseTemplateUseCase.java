...
@Transactional
public class UpdateClauseTemplateUseCase {

    private final ClauseTemplateRepositoryPort clauseTemplateRepository;

    public ClauseTemplate execute(String templateId, String promoterId, String title, String contentTemplate) {
        ...
        template.reviseContent(title, contentTemplate);
